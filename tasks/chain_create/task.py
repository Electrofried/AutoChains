...
def execute(objective_list: str) -> str:
    ...
    prompt = prompt.format(objective_list=objective_list, valid_starting_tasks=valid_starting_tasks)
    ...
    return chosen_starting_task_name, chain_so_far
